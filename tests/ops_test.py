...
class TestE2E(unittest.TestCase):
    ...
    def test_name_bastion_test_data(self):
    ...
    def test_name_bastion_test(self):
        self.assertEqual(self.runner.get_value("module.ops.aws_instance.win_test[0]", "tags"), {"Name": "win-bastion-test-1-ops-preprod-dq"})
