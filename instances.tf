module "BastionHostLinux" {
  ...
  user_data       = "CHECK_gp_SSH_TCP=${var.greenplum_ip}:${var.gp_SSH_TCP} CHECK_BDM_SSH_TCP=${var.BDM_instance_ip}:${var.BDM_SSH_TCP} CHECK_BDM_HTTPS_TCP=${var.BDM_instance_ip}:${var.BDM_HTTPS_TCP} CHECK_BDM_CUSTOM_TCP=${var.BDM_instance_ip}:${var.BDM_CUSTOM_TCP}"
