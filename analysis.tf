...
aws --region eu-west-2 ssm get-parameter --name analysis_proxy_certificate --query 'Parameter.Value' --output text --with-decryption > "/etc/letsencrypt/live/""$analysis_proxy_hostname""-0001/cert1.pem"
aws --region eu-west-2 ssm get-parameter --name analysis_proxy_certificate_key --query 'Parameter.Value' --output text --with-decryption > "/etc/letsencrypt/live/""$analysis_proxy_hostname""-0001/privkey1.pem"
ln -s /etc/letsencrypt/archive/analysis.notprod.dq.homeoffice.gov.uk-0001/cert1.pem cert1.pem
ln -s /etc/letsencrypt/archive/analysis.notprod.dq.homeoffice.gov.uk-0001/privkey1.pem privkey1.pem
chmod 0644 "/etc/letsencrypt/live/""$analysis_proxy_hostname""-0001/cert1.pem"
chmod 0644 "/etc/letsencrypt/live/""$analysis_proxy_hostname""-0001/privkey1.pem"
